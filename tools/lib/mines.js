...
module.exports = {
  ...
  windowOpts: [
    ...
    { key: 'roundedCorners', bad: (v) => v === 'true', why: 'Windows では透過と噛み合わず矩形が出ることがある（false は可）', seen: 'Electron の既知事項' },
    { key: 'opacity', bad: () => true, why: '窓全体の不透明度は矩形として合成される', seen: 'Electron の既知事項' },
